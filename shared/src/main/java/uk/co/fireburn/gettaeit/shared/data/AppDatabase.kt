...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        internal val MIGRATION_20_21 = object : Migration(20, 21) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE user_preferences ADD COLUMN startMinute INTEGER NOT NULL DEFAULT 0")
                db.execSQL("ALTER TABLE user_preferences ADD COLUMN endMinute INTEGER NOT NULL DEFAULT 0")
            }
        }
