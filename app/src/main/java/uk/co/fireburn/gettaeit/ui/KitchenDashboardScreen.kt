...
fun KitchenDashboardScreen(
    ...
    Column(
        ...
        Card(
            ...
            Text(
                text = "Scheduling a meal breaks it down into bite-sized prep tasks. These appear on your main list when it's time to cook, saving you from feeling overwhelmed!",
